...
[assembly: WebActivator.PreApplicationStartMethod(typeof(WeddingJule.App_Start.SimpleMembershipMvc3), "Start")]
[assembly: WebActivator.PostApplicationStartMethod(typeof(WeddingJule.App_Start.SimpleMembershipMvc3), "Initialize")]

namespace WeddingJule.App_Start
{
	public static class SimpleMembershipMvc3
	{
		...
		public static void Initialize()
		{
            ...
            WebSecurity.InitializeDatabaseConnection(connectionStringName: "ExpenseContext", userTableName: "Users", userIdColumn: "ID", userNameColumn: "Email", autoCreateTables: true);
